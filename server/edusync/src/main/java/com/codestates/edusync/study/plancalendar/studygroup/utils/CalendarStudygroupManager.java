...
public interface CalendarStudygroupManager {
     ...
     */
    void deleteAllTimeSchedulesByStudygroupId(Long studygroupId);
     ...
     */
    void deleteTimeScheduleByTimeScheduleId(Long studygroupId, Long timeScheduleId);
     ...
     */
    void deleteTimeScheduleWithSameTimeOfMember(Long studygroupId, Long timeScheduleId);
}
