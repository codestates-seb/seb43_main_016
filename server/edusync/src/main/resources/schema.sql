...
(
    ...
    constraint fk_classmate_member
        foreign key (member) references edusync.member (id),
    constraint fk_classmate_studygroup
        foreign key (studygroup) references edusync.studygroup (id)
);
...
(
    ...
    constraint fk_search_tag_studygroup
        foreign key (studygroup) references edusync.studygroup (id)
);
...
(
    ...
    constraint fk_studygroup_studygroup_leader
        foreign key (studygroup_leader) references edusync.classmate (id)
);
